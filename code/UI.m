...
handles.test_predict1= predict(handles.id3Tree,handles.test_features, 1:size(handles.test_features,2), handles.discrete_dim);
% 2.LM
...
handles.test_predict= predict(handles.newc45Tree,handles.test_features, 1:size(handles.test_features,2), handles.discrete_dim);
